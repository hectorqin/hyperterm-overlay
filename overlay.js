...
class Overlay {
    constructor () {
        ...
        this._tray2Image = nativeImage.createFromPath(path.join(__dirname, 'assets/images', 'tray2Template.png'));
        this._trayPressedImage = nativeImage.createFromPath(path.join(__dirname, 'assets/images', 'tray-hover.png'));
    }
